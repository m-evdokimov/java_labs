...
public class CreateXMLFile {
    public static void main(String[] args) {
        try {
            ...
            javax.xml.transform.stream.StreamResult result = new javax.xml.transform.stream.StreamResult(new File("src/lab8/example1/example.xml"));
